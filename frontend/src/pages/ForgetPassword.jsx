  ...
  return (
    <div className='min-h-screen flex items-center justify-center bg-gray-100 px-4'>
      ...
      {step==2 && <div className='bg-white shadow-md rounded-xl p-8 max-w-md w-full'>
        ...
        <form className='space-y-4' onSubmit={(e)=>e.preventDefault()}>
          <div>
            <label htmlFor="otp" className='block text-sm font-medium text-gray-700'>Please enter the 4-digit code sent tot your email.</label>
      ...
      {step==3 &&  <div className='bg-white shadow-md rounded-xl p-8 max-w-md w-full'>
        ...
        <p className='text-sm text-gray-500 text-center mb-6'>Enter a new password belwo to regain access to your account</p>
        <form className='space-y-4' onSubmit={(e)=>e.preventDefault()}>
          <div>
