  ...
  return (
     <div className="max-w-5xl mx-auto p-6 mt-10 bg-white rounded-lg shadow-md">
      ...
      <div className="flex items-center justify-center gap-5 md:justify-between flex-col md:flex-row  mb-6 relative">
        <FaArrowLeftLong  className='top-[-20%] md:top-[20%] absolute left-0 md:left-[2%] w-5.5 h-5.5 cursor-pointer' onClick={()=>navigate("/courses")}/>
        <h2 className="text-2xl font-semibold md:pl-15">Add detail information regarding course</h2>
      ...
      <div className="bg-gray-50 p-6 rounded-md">
        ...
        <form className="space-y-6" onSubmit={(e)=>e.preventDefault()}>
          ...
          h-42.5'><img src={frontendImage} alt="" className='w-full
